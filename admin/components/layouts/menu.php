            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php if(count($config['product'])>0) { ?>
                    <?php foreach($config['product'] as $k => $v) { ?>
                        <?php
                            ...
                            $active = "";
                            $menuopen = "";
                            if($kiemtra) if(check_access('product', 'man_list', $k, null, 'phrase-1') && check_access('product', 'man_cat', $k, null, 'phrase-1') && check_access('product', 'man_item', $k, null, 'phrase-1') && check_access('product', 'man_sub', $k, null, 'phrase-1') && check_access('product', 'man_brand', $k, null, 'phrase-1') && check_access('product', 'man', $k, null, 'phrase-1') && check_access('import', 'man', $k, null, 'phrase-1') && check_access('export', 'man', $k, null, 'phrase-1')) $none = "d-none";
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                <?php if($v['list']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('product', 'man_list', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['cat']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('product', 'man_cat', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['item']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('product', 'man_item', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['sub']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('product', 'man_sub', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['brand']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('product', 'man_brand', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['mau']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('product', 'man_mau', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['size']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('product', 'man_size', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('product', 'man', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['import']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('import', 'man', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['export']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('export', 'man', $k, null, 'phrase-1')) $none = "d-none";
                ...
                <?php if(count($config['news'])) { ?>
                    <?php foreach($config['news'] as $k => $v) { if($v['dropdown']) { ?>
                        <?php
                            ...
                            $active = "";
                            $menuopen = "";
                            if($kiemtra) if(check_access('news', 'man_list', $k, null, 'phrase-1') && check_access('news', 'man_cat', $k, null, 'phrase-1') && check_access('news', 'man_item', $k, null, 'phrase-1') && check_access('news', 'man_sub', $k, null, 'phrase-1') && check_access('news', 'man', $k, null, 'phrase-1')) $none = "d-none";
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                <?php if($v['list']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('news', 'man_list', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['cat']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('news', 'man_cat', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['item']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('news', 'man_item', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php if($v['sub']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('news', 'man_sub', $k, null, 'phrase-1')) $none = "d-none";
                                ...
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('news', 'man', $k, null, 'phrase-1')) $none = "d-none";
                ...
                <?php if($config['shownews']) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if(check_access('news', 'man', '', $config['news'], 'phrase-2')) $none = "d-none";
                ...
                <?php if($config['order']['active']) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        if($kiemtra) if(check_access('order', 'man', '', null, 'phrase-1')) $none = "d-none";
                ...
                <?php if($config['coupon']) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        if($kiemtra) if(check_access('coupon', 'man', '', null, 'phrase-1')) $none = "d-none";
                ...
                <?php if(count($config['tags'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if(check_access('tags', 'man', '', $config['tags'], 'phrase-2')) $none = "d-none";
                        if($com=='tags')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['tags'] as $k => $v) { ?>
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('tags', 'man', $k, null, 'phrase-1')) $none = "d-none";
                ...
                <?php if(count($config['newsletter'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if(check_access('newsletter', 'man', '', $config['newsletter'], 'phrase-2')) $none = "d-none";
                        if($com=='newsletter')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['newsletter'] as $k => $v) { ?>
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('newsletter', 'man', $k, null, 'phrase-1')) $none = "d-none";
                ...
                <?php if(count($config['static'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if(check_access('static', 'capnhat', '', $config['static'], 'phrase-2')) $none = "d-none";
                        if($com=='static')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['static'] as $k => $v) { ?>
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('static', 'capnhat', $k, null, 'phrase-1')) $none = "d-none";
                ...
                <?php if(count($config['photo'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if(check_access('photo', 'photo_static', '', $config['photo']['photo_static'], 'phrase-2') && check_access('photo', 'man_photo', '', $config['photo']['man_photo'], 'phrase-2')) $none = "d-none";
                        if($com=='photo')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php if(count($config['photo']['photo_static'])) { ?>
                                <?php foreach($config['photo']['photo_static'] as $k => $v) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('photo', 'photo_static', $k, null, 'phrase-1')) $none = "d-none";
                            ...
                            <?php if(count($config['photo']['man_photo'])) { ?>
                                <?php foreach($config['photo']['man_photo'] as $k => $v) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('photo', 'man_photo', $k, null, 'phrase-1')) $none = "d-none";
                ...
                <?php if($config['places']['active']) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if(check_access('places', 'man_city', '', null, 'phrase-1') && check_access('places', 'man_district', '', null, 'phrase-1') && check_access('places', 'man_wards', '', null, 'phrase-1') && check_access('places', 'man_street', '', null, 'phrase-1')) $none = "d-none";
                        if($com=='places')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        ...
                        <ul class="nav nav-treeview">
                            <?php
                                $none = "";
                                $active = "";
                                if($kiemtra) if(check_access('places', 'man_city', '', null, 'phrase-1')) $none = "d-none";
                            ...
                            <?php
                                $none = "";
                                $active = "";
                                if($kiemtra) if(check_access('places', 'man_district', '', null, 'phrase-1')) $none = "d-none";
                            ...
                            <?php
                                $none = "";
                                $active = "";
                                if($kiemtra) if(check_access('places', 'man_wards', '', null, 'phrase-1')) $none = "d-none";
                            ...
                            <?php
                                $none = "";
                                $active = "";
                                if($kiemtra) if(check_access('places', 'man_street', '', null, 'phrase-1')) $none = "d-none";
                ...
                <!-- User -->
                <?php if($config['user']['active'] && !check_permission()) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        $menuopen = "";
                ...
                <?php if($config['onesignal']) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        if($kiemtra) if(check_access('pushOnesignal', 'man', '', null, 'phrase-1')) $none = "d-none";
                ...
                <?php if(count($config['seopage'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if(check_access('seopage', 'capnhat', '', $config['seopage']['page'], 'phrase-3')) $none = "d-none";
                        if($com=='seopage')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['seopage']['page'] as $k => $v) { ?>
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if(check_access('seopage', 'capnhat', $k, null, 'phrase-1')) $none = "d-none";
                ...
                <?php
                    $none = "";
                    $active = "";
                    if($kiemtra) if(check_access('setting', 'capnhat', '', null, 'phrase-1')) $none = "d-none";
