    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Quản lý <?= $config_type[$type][$com]['title_main'] ?></li>
            </ol>
        </div>
    </div>
</section>
...
<section class="content">
    ...
    <div class="card-footer form-group-category text-sm bg-light row">
        ...
        <?php } ?>
        <?php if ($config_type[$type][$com]['brand']) { ?>
            <div class="form-group col-xl-2 col-lg-3 col-md-4 col-sm-4 mb-2"><?= get_main_brand(); ?></div>
        <?php } ?>
    </div>
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
            <h3 class="card-title">Danh sách <?= $config_type[$type][$com]['title_main'] ?></h3>
        </div>
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <?php if (count($config_type[$type][$com]['gallery'])) { ?>
                            <th class="align-middle">Gallery</th>
                        <?php } ?>
                        <?php foreach ($config_type[$type][$com]['check'] as $key => $value) { ?>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) {
                            ...
                            <tr>
                                ...
                                <?php if ($config_type[$type][$com]['images']) { ?>
                                    <td class="align-middle">
                                        <a href="<?= $linkEdit ?><?= $linkID ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['ten_vi'] ?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?= THUMBS ?>/<?= $config_type[$type][$com]['thumb'] ?>/<?= UPLOAD_PRODUCT_L . $items[$i]['photo'] ?>" alt="<?= $items[$i]['ten_vi'] ?>"></a>
                                    </td>
                                <?php } ?>
                                <td class="align-middle">
                                    <a class="text-dark" href="<?= $linkEdit ?><?= $linkID ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['ten_vi'] ?>"><?= $items[$i]['ten_vi'] ?></a>
                                    <div class="tool-action mt-2 w-clear">
                                        <?php if ($config_type[$type][$com]['view']) { ?>
                                        ...
                                        <?php if ($config_type[$type][$com]['copy']) { ?>
                                            <div class="dropdown">
                                    ...
                                    <td class="align-middle">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdown-gallery">
                                                <?php foreach ($config_type[$type][$com]['gallery'] as $key => $value) { ?>
